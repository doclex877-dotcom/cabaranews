---
title: "How to Get a UK Skilled Worker Visa from Zimbabwe (2025 Guide)"
excerpt: "A plain-English walkthrough of the UK Skilled Worker Visa — eligibility, documents, costs, and what nobody tells you before you apply. Written by someone who went through it."
...
<div class="callout callout--info">
  ...
  <div>
    <div class="callout__title">Who this guide is for</div>
    Zimbabwean citizens applying for the UK Skilled Worker Visa for the first time. The process is similar for most African nationalities — differences are noted where relevant.
  </div>
</div>
...
<div class="callout callout--warning">
  ...
  <div>
    <div class="callout__title">Salary threshold changed in April 2024</div>
    The minimum salary was raised from £26,200 to £38,700 for most applicants in April 2024. However, there are important exceptions — health and care workers, new graduates, and shortage occupation roles have different thresholds. Check the current rules on GOV.UK before assuming you qualify.
  </div>
</div>
...
<div class="key-info">
  ...
  <div class="key-info__grid">
    <div class="key-info__item">
      <span class="key-info__label">Application fee (outside UK)</span>
      <span class="key-info__value">£719 (up to 3 years) / £1,420 (over 3 years)</span>
    </div>
    <div class="key-info__item">
      <span class="key-info__label">Healthcare surcharge</span>
      <span class="key-info__value">£1,035 per year of visa</span>
    </div>
    <div class="key-info__item">
      <span class="key-info__label">TB test (Zimbabwe)</span>
      <span class="key-info__value">Required — approx. $150–200 USD</span>
    </div>
    <div class="key-info__item">
      <span class="key-info__label">Decision time</span>
      <span class="key-info__value">3 weeks standard / 5 days priority</span>
    </div>
    <div class="key-info__item">
      <span class="key-info__label">Biometrics</span>
      <span class="key-info__value">Required at a Visa Application Centre</span>
    </div>
    <div class="key-info__item">
      <span class="key-info__label">Can bring family?</span>
      <span class="key-info__value">Yes — spouse/partner and children under 18</span>
    </div>
  </div>
</div>
...
<div class="callout callout--tip">
  ...
  <div>
    <div class="callout__title">Pro tip: check your BRP on arrival</div>
    Always check your BRP the day you collect it. Errors on BRPs — wrong dates, wrong conditions — do happen, and they must be reported to the Home Office within 10 days of collection. An uncorrected error can cause serious problems later.
  </div>
</div>
...
1. **Incorrect occupation code** — your job title must match the code your employer used on your CoS
2. **Salary below threshold** — including if your employer miscalculated allowances
3. **Maintenance funds not held for 28 days** — you must have had the £1,270 for the full 28 days continuously
4. **Incorrect IELTS test** — using Academic IELTS instead of IELTS for UKVI
5. **TB test from unapproved clinic** — only approved clinics in Zimbabwe count

## What to do next

1. Check whether your prospective employer is on the Register of Licensed Sponsors (GOV.UK)
2. Book your IELTS for UKVI test — these have a lead time of several weeks
3. Visit an approved TB testing clinic in Harare
4. Ask your employer explicitly what costs they will cover
5. Gather bank statements now — you need 28 consecutive days of evidence

If you have a specific question about your situation, use our [contact form](/contact) — I do read them.
